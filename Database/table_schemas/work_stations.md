...
|-------------|-----------|----------|---------|-------------|-------------|
| `system_id` | `integer(32)` | NO |  | PRIMARY KEY | [FILL] |
| `branch_sk` | `integer(32)` | NO |  |  | [FILL] |
| `resource_group_id` | `integer(32)` | NO |  | [FK - FILL] | [FILL] |
| `system_type_sk` | `integer(32)` | YES |  |  | [FILL] |
| `system_code` | `character varying(50)` | NO |  |  | [FILL] |
| `system_name` | `character varying(100)` | YES |  |  | [FILL] |
...
| `current_status` | `USER-DEFINED` | NO | `'AVAILABLE'::workstation_status_enum` |  | [FILL] |
| `resource_type_id` | `integer(32)` | YES |  | [FK - FILL] | [FILL] |
...
|--------------|-------|----------|---------|
| `trg_work_stations_updated_at` | BEFORE UPDATE | `update_updated_at_column()` | Auto-update updated_at |
...
-- Use: \d work_stations in psql or pg_dump
```
