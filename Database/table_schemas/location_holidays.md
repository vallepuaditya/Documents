# location_holidays Table Schema

**Table:** `location_holidays`
...
|-------------|-----------|----------|---------|-------------|-------------|
| `location_holiday_id` | `integer(32)` | NO |  | PRIMARY KEY | [FILL] |
| `location_id` | `integer(32)` | NO |  | [FK - FILL] | [FILL] |
| `holiday_name` | `character varying(150)` | NO |  |  | [FILL] |
| `start_date` | `date` | NO |  |  | [FILL] |
| `end_date` | `date` | NO |  |  | [FILL] |
| `closure_type` | `character varying(30)` | YES |  |  | [FILL] |
...
| `updated_at` | `timestamp without time zone` | YES |  |  | [FILL] |
...
|--------------|-------|----------|---------|
| `trg_location_holidays_updated_at` | BEFORE UPDATE | `update_updated_at_column()` | Auto-update updated_at |
...
-- Use: \d location_holidays in psql or pg_dump
```
