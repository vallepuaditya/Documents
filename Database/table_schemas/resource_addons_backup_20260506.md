...
**Table:** `resource_addons_backup_20260506`
...
|------------|-------------|-------|
| `resource_addons_backup_20260506` | `[FILL: FK / trigger / etc]` | `[FILL: description]` |
...
|--------------|-------|----------|---------|
| `trg_resource_addons_backup_20260506_updated_at` | `BEFORE UPDATE` | `fn_update_timestamp()` | Auto-update `updated_at` |
| `[FILL]` | `[FILL]` | `[FILL]` | `[FILL]` |
...
-- Indexes
-- CREATE INDEX idx_resource_addons_backup_20260506_[column] ON [table_name]([column]);

-- Triggers
-- CREATE TRIGGER trg_resource_addons_backup_20260506_updated_at
