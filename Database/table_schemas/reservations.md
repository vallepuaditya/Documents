...
| `resource_id_sk` | `integer(32)` | NO |  |  | [FILL] |
| `user_id_sk` | `integer(32)` | NO |  |  | [FILL] |
| `status_sk` | `integer(32)` | NO |  |  | [FILL] |
| `allocation_date` | `date` | NO |  |  | [FILL] |
| `allocation_time` | `time without time zone` | YES |  |  | [FILL] |
| `allocation_duration` | `integer(32)` | YES | `0` |  | [FILL] |
...
|--------------|-------|----------|---------|
| `trg_reservations_updated_at` | BEFORE UPDATE | `update_updated_at_column()` | Auto-update updated_at |
...
-- Use: \d reservations in psql or pg_dump
```
