...
|------------|-------------|-------|
| `[FILL: table_name]` | `[FILL: FK / trigger / etc]` | `[FILL: description]` |
...
|--------------|-------|----------|---------|
| `trg_[table]_updated_at` | `BEFORE UPDATE` | `fn_update_timestamp()` | Auto-update `updated_at` |
| `[FILL]` | `[FILL]` | `[FILL]` | `[FILL]` |
