# staff_role_permissions Table Schema
...
| `permission_id` | `uuid` | NO |  | [FK - FILL] | [FILL] |
| `assigned_by` | `uuid` | YES |  |  | [FILL] |
...
|--------------|-------|----------|---------|
| `trg_staff_role_permissions_updated_at` | BEFORE UPDATE | `update_updated_at_column()` | Auto-update updated_at |
...
-- Use: \d staff_role_permissions in psql or pg_dump
```
